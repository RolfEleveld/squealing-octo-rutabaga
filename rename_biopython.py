...
for fha in listOfFiles:
    ...
    with open(f, "r") as fi:
        ...
        new=new.replace("/","_")
        new=new.replace(":","_")
        new=new.replace("_assembly","")
        new=new.replace("_complete","")
        new=new.replace("cov_","c")
        new=new.replace("_fragments","")
        new=new.replace("_genome","")
        new=new.replace("length_","l")
        new=new.replace("NODE_","n")
        new=new.replace("_sequence","")
        new=new.replace("_shotgun","")
        new=new.replace("_strain","")
        new=new.replace("_Streptococcus","_S")
